...
function Cards() {
  return (
    <section className="cards">
      ...
      <Card
        image="/assets/cards/saints-row.jpg"
        actionRpg
        rating="3"
        votes="0"
      ...
      <Card
        image="/assets/cards/paladins.jpg"
        mmorpg
        rating="8"
        votes="1,820"
      ...
      <article className="card">
        <a className="card__link" href="#">
          ...
          <img
            ...
            src="/assets/cards/paladins.jpg"
            alt="Card image"
          />
          <p className="card__badge card__badge_type_multiplayer-rpg">
            Multiplayer RPG
          </p>
      ...
      <article className="card">
        <a className="card__link" href="#">
          ...
          <p className="card__description">
            Includes access to World of Warcraft, Burning Crusade Classic, and
            WoW Classic!
          </p>
          <div className="card__price">
            <div className="card__price-container">
      ...
      <article className="card">
        <a className="card__link" href="#">
          ...
          <img
            className="card__image"
            src="/assets/cards/spider-man-miles-morales.jpg"
            alt="Card image"
          />
          <p className="card__badge card__badge_type_action">Action</p>
      ...
      <article className="card">
        <a className="card__link" href="#">
          ...
          <img
            className="card__image"
            src="/assets/cards/guardians-of-the-galaxy.jpg"
            alt="Card image"
          />
          <p className="card__badge card__badge_type_shooter">Shooter</p>
      ...
      <article className="card">
        <a className="card__link" href="#">
          ...
          <img
            className="card__image"
            src="/assets/cards/crash-team-racing.jpg"
            alt="Card image"
          />
          <p className="card__badge card__badge_type_shooter">Shooter</p>
      ...
      <article className="card">
        <a className="card__link" href="#">
          ...
          <img
            className="card__image"
            src="/assets/cards/spider-man.jpg"
            alt="Card image"
          />
          <p className="card__badge card__badge_type_multiplayer-rpg">
            Multiplayer RPG
